...
public class YouTubeAnalysisPlugin
{
        ...
        string videoUrl)
    {
        try
        {
            ...
            transcriptBuilder.AppendLine($"📹 VIDEO INFORMATION");
        ...
        [Description("Topic, keyword, or question to search for in the video")] string searchQuery)
    {
        try
        {
            ...
            {
                return $"🔍 No relevant content found for '{searchQuery}' in this video.";
            }

            var result = new StringBuilder();
            result.AppendLine($"🔍 Found {relevantChunks.Count} relevant sections about '{searchQuery}':");
            result.AppendLine();
        ...
        [Description("YouTube video URL")] string videoUrl)
    {
        try
        {
            ...
            var result = new StringBuilder();
            result.AppendLine("📹 VIDEO INFORMATION");
