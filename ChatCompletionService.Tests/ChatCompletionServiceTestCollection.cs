...
using DomainChatRole = ChatCompletionService.Domain.Enums.ChatRole;

namespace ChatCompletionService.Tests;

[CollectionDefinition("ChatCompletionService Integration Tests")]
public class ChatCompletionServiceTestCollection : ICollectionFixture<TestFixture>
{
}
...
[Collection("ChatCompletionService Integration Tests")]
